...
@Component({
  ...
  imports: [MaterialModule, RegistroAdminComponent, UsuariosComponent, NgIf, TurnosAdminComponent, SolicitarTurnoAdminComponent, TodoUsuariosComponent, GraficosComponent],
